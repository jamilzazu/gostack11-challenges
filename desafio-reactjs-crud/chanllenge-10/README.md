...
- Clone este repositório ```git clone https://github.com/jamilzazu/gorestaurant.git```
...
Esse projeto está sob a licença MIT. Veja o arquivo <a href="https://github.com/jamilzazu/gorestaurant/blob/master/LICENSE">LICENSE</a> para mais detalhes.
